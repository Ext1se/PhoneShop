...
<#--    <div class="mt-4 form-row">
    ...
    <div class="row mt-2 align-self-start">
            ...
            <div class="mt-2">
                ...
                <div id="ramFilter" class="row justify-content-center collapse show">
                    <div class="col-6 form-group">
                        <label>От</label>
                        <input type="number" class="form-control" min="1" max="32" placeholder="1 ГБ" v-model="filter.ramFrom">
                    </div>

                    <div class="col-6 form-group">
                        <label>До</label>
                        <input type="number" class="form-control" min="1" max="32" placeholder="8 ГБ" v-model="filter.ramTo">
                    </div>
                </div>
            </div>
        <#--Основная память-->
            <div class="mt-2">
                ...
                <div id="storageFilter" class="row justify-content-center collapse show">
                    <div class="col-6 form-group">
                        <label>От</label>
                        <input type="number" class="form-control" min="1" max="1024" placeholder="1 ГБ" v-model="filter.storageFrom">
                    </div>

                    <div class="col-6 form-group">
                        <label>До</label>
                        <input type="number" class="form-control" min="1" max="1024" placeholder="32 ГБ" v-model="filter.storageTo">
                    </div>
                </div>
            </div>
        <#--Стоимость-->
            <div class="mt-2">
                ...
                <div id="costFilter" class="row justify-content-center collapse show">
                    ...
                    <div class="col-6 form-group">
                        <label>До</label>
                        <input type="number" class="form-control" min="1"  placeholder="1000000 руб" v-model="filter.costTo">
                    </div>
                </div>
            </div>
        ...
        <div class="col-9 align-self-start">
            <div class="card mt-2 mb-2" v-for="(phone, indexPhone) in phones">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-10 ">
                            <div>
                                <h5><a v-bind:href="'model/' + phone.colorModel.model.id">{{getModelName(phone)}}</a>
                                </h5>
                            </div>
                            <div>
                                <span>{{phone.colorModel.color.name}}, {{phone.os.name}},
                            {{phone.ram}} Гб х {{phone.storage}} Гб,
                            {{phone.cost}} руб.
                                </span>
                            </div>
                            <div class="row mt-2">
                                <div class="col-auto">
                                    <button :id="'btnEdit' + indexPhone" class="btn btn-sm btn-outline-success"
                                            v-on:click="openUrl(phone)">
                                        <span class="fas fa-edit mr-2"></span>Редактировать
                                    </button>
                                    <button :id="'btnRemove' + indexPhone" class="btn btn-sm btn-outline-danger"
                                            v-on:click="remove(phone, indexPhone)">
                                        <span class="fas fa-close mr-2"></span>Удалить
                                    </button>
                                    <span :id="'spinnerModel' + indexPhone" class="spinner-border-sm mr-3"
    ...
    <script src="/js/vue_smartphones.js"></script>
</@common.page>